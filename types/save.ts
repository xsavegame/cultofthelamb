...
export const SaveFileSchema = Type.Object({
  ...
  BeatenDungeon1: Type.Boolean(),
  BeatenDungeon2: Type.Boolean(),
  BeatenDungeon3: Type.Boolean(),
  BeatenDungeon4: Type.Boolean(),
  BeatenDungeon5: Type.Boolean(),
  BeatenDungeon6: Type.Boolean(),
  BeatenDeathCat: Type.Boolean(),
  BeatenWitnessDungeon1: Type.Boolean(),
  BeatenWitnessDungeon2: Type.Boolean(),
  BeatenWitnessDungeon3: Type.Boolean(),
  BeatenWitnessDungeon4: Type.Boolean(),
  MysticKeeperBeatenLeshy: Type.Boolean(),
  MysticKeeperBeatenHeket: Type.Boolean(),
  MysticKeeperBeatenKallamar: Type.Boolean(),
  MysticKeeperBeatenShamura: Type.Boolean(),
  MysticKeeperBeatenAll: Type.Boolean(),
  MysticKeeperBeatenYngya: Type.Boolean(),
  BeatenLeshyLayer2: Type.Boolean(),
  BeatenHeketLayer2: Type.Boolean(),
  BeatenKallamarLayer2: Type.Boolean(),
  BeatenShamuraLayer2: Type.Boolean(),
  Dungeon1_Layer: Type.Number(),
  Dungeon2_Layer: Type.Number(),
  Dungeon3_Layer: Type.Number(),
  Dungeon4_Layer: Type.Number(),
  Dungeon5_Layer: Type.Number(),
  Dungeon6_Layer: Type.Number(),
  MissionariesCompleted: Type.Number(),
  BossesCompleted: Type.Array(Type.Number()),
  BossesEncountered: Type.Array(Type.Number()),
});
